...
Route::middleware(['auth', 'first.login', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/dossiers/{id}/etudiants/{etudiantId}/refuser', [AdminDossierController::class, 'refuserEtudiant'])->name('dossiers.etudiants.refuser');
    Route::post('/dossiers/{id}/etudiants/{etudiantId}/retablir', [AdminDossierController::class, 'retablirEtudiant'])->name('dossiers.etudiants.retablir');
