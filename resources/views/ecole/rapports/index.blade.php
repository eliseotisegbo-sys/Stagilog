                        ...
                        <td class="py-3 px-4">
                            ...
                            @elseif($etu->rapport)
                                <a href="{{ asset('uploads/rapports/' . $etu->rapport) }}" target="_blank" 
                                   class="inline-flex items-center space-x-1.5 px-2.5 py-1.5 bg-emerald-50 text-emerald-700 rounded-xl font-bold text-[10px]">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                                    <span>Rapport</span>
                                </a>
                            @else
                                <span class="text-slate-400 italic text-[10px]">Aucun livrable</span>
                            @endif
                        </td>
