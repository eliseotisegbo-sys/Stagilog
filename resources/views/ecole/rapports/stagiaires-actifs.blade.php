...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="relative max-w-md w-full">
            ...
            <input type="text" id="live-search-ecole-stagiaires"
                   placeholder="Rechercher par nom d'étudiant, email, filière..." 
    ...
    <div class="bg-white rounded-3xl shadow-card border border-slate-100 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-left text-xs" id="ecole-stagiaires-table">
...
@push('scripts')
<script>
document.getElementById('live-search-ecole-stagiaires').addEventListener('input', function(e) {
    const term = e.target.value.toLowerCase().trim();
    const rows = document.querySelectorAll('#ecole-stagiaires-table tbody tr.search-row');
