...
<head>
    ...
    <title>Vos identifiants de connexion STAGILOG</title>
    <style>
        ...
        <div class="container">
            ...
            <div class="content">
                <p class="greeting">
                    ...
                    Nous vous informons que les identifiants d'accès à la plateforme <strong>STAGILOG</strong> pour votre compte ont été mis à jour par l'administration.<br><br>
                    Vous trouverez ci-dessous vos nouveaux accès.
                </p>
                ...
                <div class="credentials-card">
                    <div class="credential-row">
                        ...
                        <span class="credential-value url-val">{{ $urlConnexion }}</span>
                    </div>
                    <div class="credential-row">
                        <span class="credential-label">Identifiant (email) :</span>
                        <span class="credential-value email-val">{{ $user->email }}</span>
                    </div>
                    <div class="credential-row">
                ...
                <div class="cta-center">
                    <a href="{{ $urlConnexion }}" class="cta-btn">Accéder à STAGILOG</a>
                </div>

                <div class="divider"></div>

                <div class="notice">
                    <strong>⚠️ Sécurité :</strong> Un code de vérification vous sera envoyé par email lors de votre connexion. Veuillez garder ces informations confidentielles et ne pas les partager.
                </div>
