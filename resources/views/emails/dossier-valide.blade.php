...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .detail-value.code { font-family: 'Courier New', monospace; color: #1B3A8C; background: #EEF4FF; padding: 4px 10px; border-radius: 8px; border: 1px solid #BFDBFE; font-size: 14px; }
        .detail-value.period { color: #047857; }
        .cta-center { text-align: center; margin: 28px 0; }
        .cta-btn { display: inline-block; background: linear-gradient(135deg, #059669 0%, #047857 100%); color: white !important; text-decoration: none; padding: 16px 36px; border-radius: 14px; font-size: 14px; font-weight: 800; letter-spacing: 0.3px; box-shadow: 0 8px 25px rgba(5, 150, 105, 0.3); }
        ...
        <div class="container">
            ...
            <div class="content">
                <p class="greeting">
                    ...
                    Nous avons le plaisir de vous informer que votre dossier de demande de stage a été <strong>officiellement examiné et validé</strong> par la direction technique de <strong>Technology Forever Group SARL</strong>.<br><br>
                    Les étudiants de votre promotion peuvent désormais intégrer nos locaux à compter de la date de début convenue dans le dossier.
                </p>
                ...
                <div class="success-banner">
                    ...
                    <div class="success-text">
                        Dossier validé — Les stagiaires peuvent commencer directement à partir de la période définie ci-dessous.
                    </div>
                </div>
