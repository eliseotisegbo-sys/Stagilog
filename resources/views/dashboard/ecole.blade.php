    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-card p-5 relative">
        <form method="GET" action="{{ route('dashboard.ecole') }}" id="period-form" class="flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ route('dashboard.ecole') }}" class="inline-flex items-center justify-center gap-1.5 bg-slate-100 hover:bg-slate-200 text-slate-600 px-3.5 py-2 rounded-2xl text-xs font-bold transition" title="Réinitialiser à toutes les périodes">
