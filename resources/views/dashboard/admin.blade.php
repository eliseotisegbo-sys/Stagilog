...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-card p-5">
        <form method="GET" action="{{ route('dashboard.admin') }}" id="period-form" class="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                <a href="{{ route('dashboard.admin') }}" class="inline-flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 text-slate-600 px-4 py-2.5 rounded-xl text-xs font-bold transition">
