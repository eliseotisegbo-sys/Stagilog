        ...
        <div class="lg:col-span-8 bg-white p-8 rounded-3xl shadow-card border border-slate-100">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-xs font-medium text-slate-400">Nombre réel de dossiers enregistrés par mois</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-6 bg-white p-8 rounded-3xl shadow-card border border-slate-100">
            <div class="mb-6">
                ...
                <p class="text-xs font-medium text-slate-400">Nombre de dossiers selon les filières techniques</p>
            </div>
        ...
        <div class="lg:col-span-6 bg-white p-8 rounded-3xl shadow-card border border-slate-100">
            <div class="mb-6">
                ...
                <p class="text-xs font-medium text-slate-400">Classement selon les dossiers déposés</p>
            </div>
